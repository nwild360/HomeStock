...
function AddItemButton({ onClick }: AddItemButtonProps) {
  return (
    <button
      onClick={onClick}
      className="appearance-none w-full flex items-center justify-center !bg-slate-950 hover:!bg-lime-400 text-white hover:text-slate-950 font-medium py-3 px-4 rounded-lg transition-colors relative"
    >
      <svg 
