                ...
                <td className="px-2 py-2 md:px-4 md:py-3 text-center">
                  <div className="flex items-center justify-center gap-1 md:gap-2">
                    ...
                    <button
                      ...
                      className="px-2 py-1 md:px-3 md:py-2 bg-red-500 text-white text-xs md:text-sm rounded-md hover:bg-red-600 transition-colors inline-flex items-center justify-center gap-1 md:gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
