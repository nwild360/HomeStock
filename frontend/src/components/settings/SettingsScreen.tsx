...
import McpSettingsOverlay from './McpSettingsOverlay';
    ...
    <div className="flex-1 w-full min-w-0 p-3 md:p-8 bg-gray-50 dark:bg-gray-900 overflow-auto">
      ...
      <section className="mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <div className="flex items-center justify-between p-5">
            <div>
              <p className="text-gray-900 dark:text-gray-100 font-medium">MCP Server</p>
              <p className="text-gray-500 text-sm mt-0.5">
                Let AI agents manage inventory via the Model Context Protocol
              </p>
            </div>
            <button
      ...
      <McpSettingsOverlay isOpen={isMcpOpen} onClose={() => setIsMcpOpen(false)} />
    </div>
  );
}
